...
import { BarChart3, GitGraph, Sparkles, Target } from 'lucide-react';
...
export default function AppHome() {
  return (
    <div className="min-h-screen bg-background">
      <header className="border-b bg-card py-4 px-6 sticky top-0 z-50 shadow-sm">
      ...
      <main className="max-w-7xl mx-auto p-4 md:p-8">
        <Tabs defaultValue="viz" className="w-full space-y-8">
          ...
          <TabsContent value="viz" className="mt-0 focus-visible:outline-none">
            <VisualizationsPage />
          </TabsContent>
